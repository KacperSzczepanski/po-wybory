...
public class WyborcaTyp4 extends Wyborca {
    private final int numerCechy;

    public WyborcaTyp4(String imie, String nazwisko, int numerOkregu, int numerCechy) {
    ...
    public Kandydat zaglosuj(Kandydat[][] kandydaci) {
        ...
        for (int i = 1; i < liczbaPartii; ++i) {
            ...
            for (int j = 1; j < dlugoscListy; ++j) {
                ...
                if (cechy[numerCechy] > najwiekszaWartosc) {
                    najwiekszaWartosc = cechy[numerCechy];
                    numerPartii.clear();
                    numerNaLiscie.clear();
                    numerPartii.add(i);
                    numerNaLiscie.add(j);
                } else if (cechy[numerCechy] == najwiekszaWartosc) {
                    numerPartii.add(i);
                    numerNaLiscie.add(j);
                }
            }
