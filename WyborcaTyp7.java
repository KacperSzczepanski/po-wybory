...
public class WyborcaTyp7 extends Wyborca {
    private int numerPartii;
    private final int numerCechy;

    public WyborcaTyp7(String imie, String nazwisko, int numerOkregu,
    ...
    public Kandydat zaglosuj(Kandydat[][] kandydaci) {
        ...
        for (int i = 1; i < dlugoscListy; ++i) {
            ...
            if (cechy[this.numerCechy] > najwiekszaWartosc) {
                najwiekszaWartosc = cechy[this.numerCechy];
                numerNaLiscie.clear();
                numerNaLiscie.add(i);
            } else if (cechy[this.numerCechy] == najwiekszaWartosc) {
                numerNaLiscie.add(i);
            }
        }
