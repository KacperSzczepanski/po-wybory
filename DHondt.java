...
public class DHondt extends Wybory {

    public DHondt(int liczbaOkregow, int liczbaPartii, int liczbaDzialan,
    ...
    public void rozdajMandaty() {
        for (int i = 1; i <= this.liczbaOkregow; ++i) {
            ...
            for (int mandaty = 0; mandaty < this.liczbyWyborcow[i] / 10; ++mandaty) {
                ...
                glosyNaPartie[ind] = kopia[ind] / (liczbaMandatow[i][ind] + 1);
            }
        }
    }
